  ...
  const features = [
    {
      ...
      description:
        language === "en"
          ? "Over 15 years designing scalable systems"
          : "15+ лет опыта проектирования масштабируемых систем",
      link: "/cv",
    },
    {
    ...
    },
    {
      ...
      description:
        language === "en"
          ? "Architecture, Java/Kotlin, Camunda, ETL — what I can help with"
          : "Архитектура, Java/Kotlin, Camunda, ETL — чем могу помочь",
      link: "/services",
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <SEO
        title={
          language === "en"
            ? "Ivan Donchenko — Lead Software Architect"
            : "Иван Донченко — Ведущий архитектор ПО"
        }
        description={
          language === "en"
            ? "Software architect with 14+ years of experience. Java/Kotlin, Camunda, microservices, ETL. Architecture audit, design, and digital transformation."
            : "Архитектор ПО с 14+ годами опыта. Java/Kotlin, Camunda, микросервисы, ETL. Аудит архитектуры, проектирование и цифровая трансформация."
        }
      />
      {/* Hero Section */}
      <section className="text-center py-20">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-2xl mx-auto">
          {language === "en"
            ...
            : "Проектирование масштабируемой и отказоустойчивой архитектуры, управление проектами цифровой трансформации"}
        </p>
