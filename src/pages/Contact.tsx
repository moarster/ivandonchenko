                ...
                <Card
                    ...
                    <p className="text-slate-700 dark:text-slate-300 mb-4">
                        {language === 'en'
                            ...
                            : 'Я всегда заинтересован в новых проектах и возможностях. Нужен архитектор ПО, технический консультант или руководитель разработки — давайте обсудим, как я могу помочь.'}
                    </p>
